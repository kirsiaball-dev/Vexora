...
local supportedGames = {
    [9363735110] = {
        ...
        url = "https://raw.githubusercontent.com/kirsiaball-dev/Vexora/refs/heads/main/E.lua"
    },
    [1234567890] = {
        name = "Garden Horizons",
        url = "https://raw.githubusercontent.com/kirsiaball-dev/Vexora/refs/heads/main/G.lua"
    }
}
...
if gameInfo then
    Notify({
        Title = "Vexora Hub",
        Content = gameInfo.name .. " script loaded!",
        Duration = 10
    })
