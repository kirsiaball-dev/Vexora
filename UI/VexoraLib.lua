...
local Icons = {
    ...
    water     = "rbxassetid://100076212730632",
...
local VexoraLib, Notification = {}, {}

VexoraLib.Unloaded = false
VexoraLib.Icons = Icons
...
function VexoraLib:CreateWindow(Config)
  local Title = Config[1] or Config.Title or ""
  local Description = Config[2] or Config.Description or ""
  ...
  local VexoraLibGui = Custom:Create("ScreenGui", {
    ZIndexBehavior = Enum.ZIndexBehavior.Sibling
  }, RunService:IsStudio() and Player.PlayerGui or (gethui() or cloneref(game:GetService("CoreGui")) or game:GetService("CoreGui")))
  ...
  local DropShadowHolder = Custom:Create("Frame", {
    ...
    ZIndex = 0,
    Name = "DropShadowHolder",
    Position = UDim2.new(0, (VexoraLibGui.AbsoluteSize.X // 2 - 455 // 2), 0, (VexoraLibGui.AbsoluteSize.Y // 2 - 350 // 2))
  }, VexoraLibGui)
  ...
  Close.Activated:Connect(function()
    ...
    if VexoraLibGui then VexoraLibGui:Destroy() end
		if not VexoraLib.Unloaded then VexoraLib.Unloaded = true end
	end)
